...
renderPlotly({
  ...
  fig <- forecast_prison_pop %>%
    ...
    plot_ly(x = ~index, y = ~ count, type = "scatter", mode='lines', hoverinfo = "x+y", name='Forecast') %>%
